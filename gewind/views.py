from .models import Coordinates,ProjectInfo
from extra_views import CreateWithInlinesView, InlineFormSet
from gewind.kmz_generator import main_run
...
class About(generic.TemplateView):
    template_name= 'gewind/about.html'

class UploadfileList(generic.ListView):
    model = Uploadfile
    ordering = ['file']

class Top(generic.TemplateView):
    template_name= 'gewind/top.html'

class Howto(generic.TemplateView):
    template_name= 'gewind/howto.html'
...
class ProjectInfoFormsetView(CreateWithInlinesView):
    ...
    template_name = "gewind/projectinfo_formset.html"
    slug_field = 'id'
    success_url = "dl/{id}/"
...
#     template_name='gewind/thanks.html'
...
#     return render(request,'gewind/coordinates_form.html',{'form':form})
